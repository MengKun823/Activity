...
var quesAns_url = "https://ma.shenlancity.com/v2/question_answer";
var ansData;
var arrDay;
var year,month,day
...
Page({
  ...
  btnShare: function () {
    var that = this;
    var share_url = "https://ma.shenlancity.com/v2/question_share_image?day=" + that.data.ansData.show_day + "&id=" + that.data.userId + "&width=598&height=838&.jpeg";
    wx.showToast({
      title: '正在生成...',
      icon: "loading"
    });
